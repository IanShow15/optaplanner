...
[NOTE]/www.optaplanner.org/xsd/solver" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
...
and does not want to wait any longer for a better one, call `.terminateEarly(problemId)`.
